...
class CleverTapVariables {
    ...
    var HomeStrings:[String: String] {
        return values?["Home"] as? [String: String] ?? [:]
    }
   
    var CarouselTitleString: String {
        return values?["Home.carouselTitle"] as? String ?? ""
    }
    var ChallengesTitleString: String {
         return values?["Home.challengesTitle"] as? String ?? "Challenges"
    }
    var CategoriesTitleString: String {
         return values?["Home.categoriesTitle"] as? String ?? "Categories"
    }
    var LoginString: String {
          return values?["Home.login"] as? String ?? "Login"
      }
    var DashboardString: String {
          return values?["Home.dashboard"] as? String ?? "Dashboard"
      }
    var DarkTheme: [String: Any] {
         return values?["DarkTheme"] as? [String: Any] ?? [:]
     }
    var LightTheme: [String: Any] {
