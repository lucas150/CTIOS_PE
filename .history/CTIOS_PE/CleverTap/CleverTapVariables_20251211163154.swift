...
class CleverTapVariables {
    ...
    var insurance: String {
        return values?["Dashbaord_Images.insurance"] as? String ?? "shield1"
    }   
    var electricity: String {
        return values?["Dashbaord_Images.electricity"] as? String ?? "bolt.fill1"
    }   
    var prepaid: String {
        return values?["Dashbaord_Images.prepaid"] as? String ?? "creditcard1"
    }  

   

    var wallet: String {
        return values?["Dashbaord_Images.wallet"] as? String ?? "wallet.pass1"
    }   
    var home: String {
        return values?["Dashbaord_Images.home"] as? String ?? "house.fill1"
    }   
    var rewards: String {
        return values?["Dashbaord_Images.rewards"] as? String ?? "gift.fill1"
    }   
    var mobile: String {        
        return values?["Dashbaord_Images.mobile"] as? String ?? "phone.fill1"
    }   
