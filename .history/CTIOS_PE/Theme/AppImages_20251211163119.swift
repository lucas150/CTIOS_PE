...
//    static let logo = UIImage(named: "aia_white")
    ...
    enum Challenges {
        static let run : UIImage(named: CleverTapVariables.shared.run)
        static let yoga : UIImage(named: CleverTapVariables.shared.yoga)
        static let meditate = UIImage(named: CleverTapVariables.shared.meditate)
    }
