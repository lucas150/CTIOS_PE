...
//    static let logo = UIImage(named: "aia_white")
    ...
    enum Icons {
        static let login = UIImage? {UIImage(named: CleverTapVariables.shared.login_image)}
        static let carInsurance = UIImage? {UIImage(named: CleverTapVariables.shared.carInsurance_image)}
        static let healthInsurance = UIImage? {UIImage(named: CleverTapVariables.shared.healthInsurance_image)}
        static let lifeInsurance = UIImage? {UIImage(named: CleverTapVariables.shared.lifeInsurance_image)}
    }
