    ...
    func applyTheme(
        ...
        UIView.animate(withDuration: 0.3) {
            ...
            if self.isChristmasThemeApplied {
                ...
                if let btnBGHex = self.iconTintHex,
                   ...
                   let textColor = UIColor(hex: textHex) {
                    ...
                    // Use configuration for proper styling
            ...
            // 🎨 DEFAULT THEME (BLUE)
                ...
                defaultConfig.cornerStyle = .large
                themeButton?.configuration = defaultConfig

                var loginConfig = UIButton.Configuration.filled()
                loginConfig.baseBackgroundColor = .systemBlue
                loginConfig.baseForegroundColor = .white
                loginConfig.cornerStyle = .large
