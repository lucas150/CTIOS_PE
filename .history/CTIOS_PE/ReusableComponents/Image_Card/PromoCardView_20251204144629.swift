...
private extension PromoCardView {
    ...
    func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            // TITLE - Full width since car is lower
            titleLabel.topAnchor.constraint(equalTo: topAnchor, constant: 20),
            titleLabel.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 20),
            titleLabel.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -20),

            // SUBTITLE - Left side only, leaving space for car image
            subtitleLabel.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 6),
            subtitleLabel.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 20),
            subtitleLabel.trailingAnchor.constraint(lessThanOrEqualTo: centerXAnchor, constant: 20),

            // BUTTON - Positioned below subtitle on left side
            ...
            // CAR IMAGE - Right side, aligned with subtitle area
            carImageView.topAnchor.constraint(greaterThanOrEqualTo: subtitleLabel.topAnchor),
            carImageView.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -10),
            carImageView.leadingAnchor.constraint(greaterThanOrEqualTo: centerXAnchor, constant: 10),
            carImageView.widthAnchor.constraint(lessThanOrEqualToConstant: 160),
            carImageView.heightAnchor.constraint(lessThanOrEqualToConstant: 100),
