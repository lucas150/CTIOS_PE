...
//
//        
//        hiddenImages = [img1, img2, img3, img4, img5, img6]
//
...
//
//        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! MyCollectionView
//
////        loadImage(from: bannerImages[indexPath.item], into: cell.myImageView)
//        return cell
//    }
//
...
//        )
//
//        // Optionally tint category/challenge icons if needed
//    }
//}
//
//
...
//        taglineLabel.font = UIFont.boldSystemFont(ofSize: 14)
//
...
//        layout.minimumLineSpacing = 20      // spacing between cards
//
...
//        carouselCollection.decelerationRate = .fast
...
//
//        carouselCollection.register(MyCollectionView.self, forCellWithReuseIdentifier: "cell")
//
...
//
//        let activeDistance: CGFloat = 220
...
//
//            let itemWidth = collectionView!.bounds.width * 0.70
...
//                    continue
//                }
//                if abs(attr.center.x - center) < abs(closest!.center.x - center) {
//                    closest = attr
//                }
//            }
//
//            return CGPoint(x: closest!.center.x - collectionSize.width / 2, y: proposedContentOffset.y)
//        }
//    }
//
//    // MARK: Categories Section
...
//
//        categoriesStack.addArrangedSubview(makeTile(imageName: "cat1"))
//        categoriesStack.addArrangedSubview(makeTile(imageName: "cat2"))
//        categoriesStack.addArrangedSubview(makeTile(imageName: "cat3"))
//
//        let container = makeCard()
//        let v = UIStackView(arrangedSubviews: [categoriesLabel, categoriesStack])
//        v.axis = .vertical
//        v.spacing = 12
...
//        challengesLabel.font = UIFont.boldSystemFont(ofSize: 20)
//
//        challengesStack.axis = .horizontal
//        challengesStack.distribution = .fillEqually
//        challengesStack.spacing = 12
//
//        challengesStack.addArrangedSubview(makeTile(imageName: "chal1"))
//        challengesStack.addArrangedSubview(makeTile(imageName: "chal2"))
//        challengesStack.addArrangedSubview(makeTile(imageName: "chal3"))
//
//        let container = makeCard()
//        let v = UIStackView(arrangedSubviews: [challengesLabel, challengesStack])
//        v.axis = .vertical
//        v.spacing = 12
//        v.translatesAutoresizingMaskIntoConstraints = false
//
...
//
//        let v = UIStackView(arrangedSubviews: [loginButton, themeButton])
//        v.axis = .vertical
//        v.spacing = 12
//
...
//    }
//
//    func makeTile(imageName: String) -> UIView {
//        let v = UIView()
